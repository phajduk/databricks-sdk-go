...
[![Build Status](https://travis-ci.org/phajduk/databricks-sdk-go.svg?branch=master)](https://travis-ci.org/phajduk/databricks-sdk-go)
...
```bash
go get -u github.com/phajduk/databricks-sdk-go
```
